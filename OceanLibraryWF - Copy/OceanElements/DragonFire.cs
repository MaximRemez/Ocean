...
{
    class DragonFire : Cell
    {
        #region Variables

        private uint _lastNumOfIteration;
        private int _timeToLife = Constant.defaultFireLife;
        #endregion
        ...
        public DragonFire(Coordinate anOffset, IOceanCells ocean, int timeToLife) : base(anOffset, ocean)
        {
            Offset = anOffset;
            _myOcean = ocean;
            ...
            Image = Constant.defaultFireImage;
        }
        #endregion
